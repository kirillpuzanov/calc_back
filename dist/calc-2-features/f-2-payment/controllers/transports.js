...
exports.transports = (req, res, user) => __awaiter(void 0, void 0, void 0, function* () {
    const currentPaymentId = req.body.currentPaymentId;
    const transports = req.body.transports;
    if (!currentPaymentId || !transports) {
        error_result_1.errorStatus400(res, 'incomplete data in the request', 404, { currentPaymentId, transports });
    }
    try {
        ...
        if (!updatePackagingCargo)
            ...
            success_result_1.successResult(res, 'update cargo(s) value success!', 200, transports);
        }
    }
    catch (err) {
