...
exports.palletParam = (req, res, user) => __awaiter(void 0, void 0, void 0, function* () {
    const { palletParameters, currentPaymentId } = req.body;
    if (!palletParameters || !currentPaymentId) {
        error_result_1.errorStatus400(res, 'incomplete data in the request', 404, { palletParameters, currentPaymentId });
    }
    try {
        ...
        if (!updatePackagingCargo)
            error_result_1.errorStatus400(res, 'not updated, bad request.../withPallet/findByIdAndUpdate', 404, {
                palletParameters,
                currentPaymentId
            });
        else {
            cookie_1.resCookie(res, user);
            success_result_1.successResult(res, 'update cargo(s) value success!', 200, { palletParameters });
        }
    }
    catch (err) {
...
//# sourceMappingURL=palletParam.js.map